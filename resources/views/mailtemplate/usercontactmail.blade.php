...
<body>
    ...
    <p> Hello {{ ucfirst($inquirydetails->contact_name) }}, </p>
    <p> Thank you for your interest in efficient corporate. You have made the inquiry with the following details. We will contact you soon.</p><br/>
    <table cellpadding="3">
    	<tr>
        	<td>Name :</td>
