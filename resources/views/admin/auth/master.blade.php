...
<head>
	<meta charset="utf-8">
  	...
  	<title>Efficient Corporate | Log in</title>
  	...
  	<!-- iCheck -->
  	<link rel="stylesheet" type="text/css" href="{{ asset("../bower_components/AdminLTE/plugins/iCheck/square/blue.css") }}" />
  	<!-- Custom -->
...
<body class="hold-transition login-page">
	...
	<!-- iCheck -->
	<script type="text/javascript" src="{{ asset("../bower_components/AdminLTE/plugins/iCheck/icheck.min.js") }}"></script>
	<script>
  		$(function(){
    		$('input').iCheck({
