...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="" role="form" method="post" action="{{ url('/admin/state') }}/{{ $stateid }}" enctype="multipart/form-data">
			{{ csrf_field() }}
       		{{ method_field('PUT') }}
				...
				<div class="row">
					<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
						<div class="form-group {{ $errors->has('state_name') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
							<input type="text" class="form-control" id="state_name" name="state_name" placeholder="Enter State Name" value="{{ $statedata->state_name }}">
						...
						<div class="form-group {{ $errors->has('state_abbr') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
							<input type="text" class="form-control" id="state_abbr" name="state_abbr" placeholder="Enter State Abbrevation" value="{{ $statedata->state_abbr }}">
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
							  ...
							  <div class="radio inline">
								<label><input type="radio" name="state_status" id="status_inactive" value="0" @if($statedata->state_status == 0) checked @endif>Inactive</label>
							  </div>
						  </div>
						</div>
					</div>
            ...
            <div class="box-footer">
			  ...
			  <a class="btn btn-primary" href="{{ url('admin/state') }}">Cancel</a>
			</div>
         </form>
