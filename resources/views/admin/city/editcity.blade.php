...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="" role="form" method="post" action="{{ url('/admin/city') }}/{{ $cityid }}" enctype="multipart/form-data">
			{{ csrf_field() }}
       		{{ method_field('PUT') }}
				...
				<div class="row">
					<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
						<div class="form-group {{ $errors->has('city_name') ? ' has-error' : '' }}">
						  <label for="state_name" class="col-sm-2 control-label">City Name<span class="required-mark">*</span> : </label>
						  <div class="col-sm-10">
							<input type="text" class="form-control" id="city_name" name="city_name" placeholder="Enter City Name" value="{{ $citydata->city_name }}">
						...
						<div class="form-group {{ $errors->has('city_abbr') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
							<input type="text" class="form-control" id="city_abbr" name="city_abbr" placeholder="Enter City Abbrevation" value="{{ $citydata->city_abbr }}">
						...
						<div class="form-group {{ $errors->has('state_id') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
						  	<select class="form-control selectbox select2" name="state_id" id="state_id">
									...
									<option value="{{ $key }}" {{ ($citydata->state_id == $key ? "selected":"") }}>{{ $state }}</option>
								@endforeach
							</select>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
							  ...
							  <div class="radio inline">
								<label><input type="radio" name="city_status" id="status_inactive" value="0" @if($citydata->city_status == 0) checked @endif>Inactive</label>
							  </div>
						  </div>
						</div>
					</div>
            ...
            <div class="box-footer">
			  ...
			  <a class="btn btn-primary" href="{{ url('admin/city') }}">Cancel</a>
			</div>
         </form>
