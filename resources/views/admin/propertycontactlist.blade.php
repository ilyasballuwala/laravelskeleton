        ...
        <div class="row">
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="box-header">
              <h3 class="box-title">Property Inquiry Contact Listing</h3>
            </div>
            ...
            <div class="box-body">
              <table id="contactlisting" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th width="25%">Reference Property</th>
                  <!--<th>Action</th>-->
                </tr>
                </thead>
                <tbody>    
					...
					@foreach($contactdata as $contact)
						<tr>
                            ...
                            <td>@if(count($contact->Propertydata) > 0) {{ ucfirst($contact->Propertydata->property_name) }} @else N/A @endif</td>							
							<!--<td>
