...
<section class="content">
    ...
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="" role="form" method="POST" action="{{ url('/admin/cms') }}" enctype="multipart/form-data">
			{{ csrf_field() }}
        	<div class="box-body">
            	<!-- Start .flash-message -->
				...
				<div class="row">
					<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
						<div class="form-group {{ $errors->has('cms_page_title') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
							<input type="text" class="form-control" id="cms_page_title" name="cms_page_title" placeholder="Enter CMS Page Title" value="{{ old('cms_page_title') }}">
						...
						<div class="form-group {{ $errors->has('cms_page_url') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
							<input type="text" class="form-control" id="cms_page_url" name="cms_page_url" placeholder="Enter CMS Page URL" value="{{ old('cms_page_url') }}">
						...
						<div class="form-group {{ $errors->has('cms_content_title') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
							<input type="text" class="form-control" id="cms_content_title" name="cms_content_title" placeholder="Enter CMS Content Title" value="{{ old('cms_content_title') }}">
						...
						<div class="form-group {{ $errors->has('cms_page_content') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
						  	<textarea id="cms_page_content" name="cms_page_content" rows="20" cols="80" class="ckeditor">{{ old('cms_page_content') }}</textarea>
						...
						<div class="form-group {{ $errors->has('cms_page_metatitle') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
							<input type="text" class="form-control" id="cms_page_metatitle" name="cms_page_metatitle" placeholder="Enter CMS Page Meta Title" value="{{ old('cms_page_metatitle') }}">
						...
						<div class="form-group {{ $errors->has('cms_page_metakeywords') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
							<input data-role="tagsinput" type="text" class="form-control tagsinput" id="cms_page_metakeywords" name="cms_page_metakeywords" placeholder="Enter CMS Page MetaKeywords" value="{{ old('cms_page_metakeywords') }}">
						...
						<div class="form-group {{ $errors->has('cms_page_metadesc') ? ' has-error' : '' }}">
						  ...
						  <div class="col-sm-10">
						  	<textarea name="cms_page_metadesc" id="cms_page_metadesc" rows="5" cols="80" placeholder="Enter Meta Description" class="form-control resizeverticleonly">{{ old('cms_page_metadesc') }}</textarea>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
							  ...
							  <div class="radio inline">
								<label><input type="radio" name="cms_page_status" id="status_inactive" value="0" {{ (old("cms_page_status") == '0' ? 'checked' : "" ) }}>Inactive</label>
							  </div>
						  </div>
						</div>
						<div class="form-group">
						  ...
						  <div class="col-sm-10">
							  ...
							  <div class="radio inline">
								<label><input type="radio" name="page_displayed_at" id="status_footer" value="2" {{ (old("page_displayed_at") == '2' ? 'checked' : "" ) }}>Footer Menu</label>
							  </div>
						  </div>
						</div>
						<div class="form-group">
						  <label for="hideon_site" class="col-sm-2 control-label">Hide Page On Site : </label>
						  	<div class="col-sm-10">
							    <div class="checkbox marginnone">
								  <label>
									<input type="checkbox" name="hideon_site" id="hideon_site" data-ng-model="hideon_site"> Yes, i don't want to show this page on site
								  </label>
								</div>
						  	</div>	
						</div>
						<div class="form-group" data-ng-hide="hideon_site">
						  ...
						  <div class="col-sm-10">
						  	<select class="form-control selectbox select2" name="cms_parent_page" id="cms_parent_page">
									...
									<option value="{{ $key }}" {{ (old("cms_parent_page") == $key ? "selected":"") }}>{{ $pagename }}</option>
								@endforeach
							</select>
						  </div>
						</div>
